...
class MoviesHomePageAdapter(private val movieData: List<MovieData>) : RecyclerView.Adapter<MoviesHomePageViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MoviesHomePageViewHolder, position: Int) {
       holder.fillCard(movieData = movieData[position])
    }

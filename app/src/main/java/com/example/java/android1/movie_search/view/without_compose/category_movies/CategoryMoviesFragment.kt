package com.example.java.android1.movie_search.view.without_compose.category_movies
...
class CategoryMoviesFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            categoryName = it.getString(ARG_CATEGORY_NAMEData)
        }
    }
    ...
    companion object {
        const val ARG_CATEGORY_NAMEData = "CategoryData Name"
